# Part of < https://github.com/CuTePsYcHo_110/TelegraphUploader >
# (c) 2021 @CuTePsYcHo.
...
async def _(event):
    ...
    if (await check_user(event.sender_id)) == False:
        return await event.edit(f"{ok.user.first_name}, please join my channel to use me!", buttons=[Button.url("Join Channel", url="https://t.me/CrAzIe_BoTz")])
